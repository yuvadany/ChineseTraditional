...
public class BooksChapters {
    ...
    public static String getBookName(int booknumber)
    {
        ...
        bookName.put(6 ,"Isus Navin-Joshua");
        bookName.put(7 ,"Sudije-Judges" );
        ...
        bookName.put(13 ,"1. Dnevnika-1 Chronicles" );
        bookName.put(14 ,"2. Dnevnika-2 Chronicles");
        bookName.put(15 ,"Ezra-Ezra");
        bookName.put(16 ,"Nehemija-Nehemiah");
        bookName.put(17 ,"Jestira-Esther");
        bookName.put(18 ,"Jov-Job");
        bookName.put(19 ,"Psalmi-Psalms" );
        bookName.put(20 ,"Poslovice-Proverbes" );
        bookName.put(21 ,"Propovednik-Ecclesiastes");
        bookName.put(22 ,"Pesma nad pesmama-Song of Songs");
        bookName.put(23 ,"Isaija-Isaiah");
        bookName.put(24 ,"Jeremija-Jeremiah" );
        bookName.put(25 ,"Jeremijine tužbalice-Lamentations" );
        bookName.put(26 ,"Jezekilj-Ezekiel");
        bookName.put(27 ,"Danilo-Daniel" );
        bookName.put(28 ,"Osija-Hosea" );
        bookName.put(29 ,"Joil-Joel");
        bookName.put(30 ,"Amos-Amos");
        bookName.put(31 ,"Ovadija-Obadiah");
        bookName.put(32 ,"Jona-Jonah");
        bookName.put(33 ,"Mihej-Micah" );
        bookName.put(34 ,"Naum-Nahum");
        bookName.put(35 ,"Avakum-Habakkuk" );
        bookName.put(36 ,"Sofonija-Zephaniah" );
        bookName.put(37 ,"Agej-Haggai");
        bookName.put(38 ,"Zaharija-Zechariah");
        bookName.put(39 ,"Malahija-Malachi");
        bookName.put(40 ,"Mateju-Matthew");
        bookName.put(41 ,"Marku-Mark");
        bookName.put(42 ,"Luki-Luke" );
        bookName.put(43 ,"Jovanu-John");
        bookName.put(44 ,"Dela apostolska-Acts" );
        ...
        bookName.put(58 ,"Jevrejima-Hebrews");
        bookName.put(59 ,"Jakovljeva-James" );
        bookName.put(60 ,"1. Petrova-1 Peter");
        bookName.put(61 ,"2. Petrova-2 Peter");
        bookName.put(62 ,"1. Jovanova-1 John");
        bookName.put(63 ,"2. Jovanova-2 John");
        bookName.put(64 ,"3. Jovanova-3 John");;
        bookName.put(65 ,"Judina-Jude");
        bookName.put(66 ,"Apokalipsa-Revelation");
